            ...
            <div class="row gy-5 gy-xl-0 justify-content-center justify-content-lg-between align-items-center">
                ...
                <!-- signin start -->
                    <form method="POST" autocomplete="off" id="frmContactus" class="sign-up__form me-lg-4 me-xxl-0">
                        ...
                        <p class="have_account">Do you have an account? <a href="<?php echo e(route('signup')); ?>" class="signin">Signup</a></p>
                        <span id="msg"></span> 
...
<script>
    ...
    $(document).ready(function() {
        $('#frmContactus').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('login')); ?>", // Route defined in web.php
                method: "POST",
                ...
                success: function(response) {
                    ...
                    window.location.href = "<?php echo e(route('userDashboard')); ?>"; // Replace with your target route
                },
    ...
    $(document).ready(function() {
        $('#forgetPasswordForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('sendOtp')); ?>", // Route defined in web.php
                method: "POST",
                data: $(this).serialize(), // Serialize the form data
                success: function(response) {
    ...
    $(document).ready(function() {
        $('#otpForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('verifyOtp')); ?>", // Route defined in web.php
                method: "POST",
                data: $(this).serialize(), // Serialize the form data
                success: function(response) {
    ...
    $(document).ready(function() {
        $('#newPasswordForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('resetPassword')); ?>", // Route defined in web.php
                method: "POST",
                data: $(this).serialize(), // Serialize the form data
                success: function(response) {
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\reviewProject\resources\views/frontend/signin.blade.php ENDPATH**/ ?>