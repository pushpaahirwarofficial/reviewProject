            ...
            <div class="row gy-5 gy-xl-0 justify-content-center justify-content-lg-between align-items-center">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <form method="POST" autocomplete="off" id="frmContactus" class="sign-up__form me-lg-4 me-xxl-0 wow fadeInUp" data-wow-duration="0.8s">
                        ...
                        <p class="have_account mt_24">Do you have an account? <a href="<?php echo e(route('signin')); ?>" class="signin">Signin</a></p>
                        <span id="msg"></span> 
...
<script>
    $(document).ready(function() {
        $('#frmContactus').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('registration')); ?>", // Route defined in web.php
                method: "POST",
                ...
                success: function(response) {
                    ...
                    window.location.href = "<?php echo e(route('signin')); ?>"; // Replace with your target route
                },
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\reviewProject\resources\views/frontend/signup.blade.php ENDPATH**/ ?>