...
<?php $__env->startSection('pagetitle'); ?> Page Not Found <?php $__env->stopSection(); ?>
<?php $__env->startSection('keywords'); ?> Page Not Found <?php $__env->stopSection(); ?>
<?php $__env->startSection('description'); ?> Page Not Found <?php $__env->stopSection(); ?>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8 col-xxl-6">
                    <div class="section__content mt-5">
                        ...
                        <a href="<?php echo e(route('index')); ?>" class="btn_theme btn_theme_active mt_40  wow fadeInUp" data-wow-duration="0.8s">Back To Home<i class="bi bi-arrow-up-right"></i><span></span></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\Laravel\reviewProject\resources\views/errors/404.blade.php ENDPATH**/ ?>