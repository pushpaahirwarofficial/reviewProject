...
@section('userName')
    @php
        $name1 = session('userData')->name ? session('userData')->name . ' | Add Company' : 'Default Title';
    @endphp
    {{ $name1 }}
@endsection
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material mx-2" id="addCompanyForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-line" name="company_name" placeholder="Enter Company Name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-line" name="subtitle" placeholder="Enter Company Subtitle">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <input type="text" name="feature_1" id="feature_1" placeholder="Feature 1" class="form-control form-control-line">
                                            </div>
                                            <div class="col-md-6">
                                            <label for="feature_2">Feature 2</label>
                                            <input type="text" name="feature_2" id="feature_2" placeholder="Feature 2" class="form-control form-control-line">
                                            </div> 
                                            <div class="col-md-6">
                                            <label for="feature_3">Feature 3</label>
                                            <input type="text" name="feature_3" id="feature_3" placeholder="Feature 3" class="form-control form-control-line">
                                            </div>
                                            <div class="col-md-6">
                                            <label for="feature_4">Feature 4</label>
                                            <input type="text" name="feature_4" id="feature_4" placeholder="Feature 4" class="form-control form-control-line">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                        <input type="text" name="website" id="website" placeholder="https://www.example.com" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                        <textarea class="form-control form-control-line" name="description" id="cke_description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-line" name="benefit" id="benefit"></textarea>
                                        </div>
                                        <div class="col-md-6">
                                        <label class="col-md-6">Terms</label>
                                        <textarea class="form-control form-control-line" name="terms" id="terms"></textarea>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-line" name="pros" id="pros"></textarea>
                                        </div>
                                        <div class="col-md-6">
                                        <label class="col-md-6">Cons</label>
                                        <textarea class="form-control form-control-line" name="cons" id="cons"></textarea>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white">Add Company</button>
                                            </form>
...
@endsection
    ...
    $(document).ready(function() {
        $('#addCompanyForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('insertCompany') }}", // Adjust route name accordingly
                type: "POST",
                data: formData,
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        window.location.href="{{ route('addCompany') }}";
                    } else {
